...
<kbd>![git add all screenshot](screenshots/commit-4.1.png)</kbd>
...
<kbd>![git log screenshot](screenshots/commit-8.png)</kbd>
...
<kbd>![Fetch VS Pull](diagrams/fetch-vs-pull.jpg)</kbd>
...
<kbd>![Merge Conflict2](screenshots/pull-2.2.png)</kbd>  
...
3. You have some staged or unstaged changes on your local repository  
  ...
  * Run `git stash pop <STASH-HASH>` to see if you can merge without a conflict, if there's a conflict a similar error will appear:  
  <kbd>![Merge Conflict6](screenshots/pull-3.png)</kbd>
